...
import com.lexing.batterytest.batteryhelper.v18.BatterySipper;
import com.lexing.batterytest.batteryhelper.v18.BatteryStatsHelper;

import java.util.ArrayList;
import java.util.List;

public class BelowJellyBeanActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        helper.setMinPercentOfTotal(0.01);
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 1:
                    ...
                    batterySummary.setText(mBatterySummary + "\n测试信息：获取方式" + (helper.testType == 1 ? "(根据记录文件)" : "(根据CPU使用时间)"));
    ...
    class customAdapter extends BaseAdapter {
        ...
        public customAdapter() {
            inflater = LayoutInflater.from(BelowJellyBeanActivity.this);
        }

        public void setData(List<BatterySipper> sipperList) {

            List<BatteryInfo> list = new ArrayList<>();
            for (int i = list.size() - 1; i >= 0; i--) {
                final BatterySipper sipper = sipperList.get(i);
                ...
                if (name == null) {
                    ...
                    if (name != null) {
                        ...
                        info.setIcon(icon);
                        info.setPercentOfTotal(sipper.getPercentOfTotal());
                        list.add(info);
                    }
                }
            }
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            BatteryInfo appInfo = getItem(position);
    ...
    private BroadcastReceiver mBatteryInfoReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (Intent.ACTION_BATTERY_CHANGED.equals(action)) {
                ...
                String batteryStatus = Utils.getBatteryStatus(BelowJellyBeanActivity.this.getResources(), intent);
