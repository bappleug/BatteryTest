...
public class BatterySipper implements Comparable<BatterySipper> {
	...
	private BatteryStatsImplV18.UidWrapper uidObj;
	...
	public BatterySipper(Context context, DrainType type, BatteryStatsImplV18.UidWrapper uid, double[] values) {
		mContext = context;
		this.values = values;
		this.drainType = type;
		if (values != null)
	...
	private void getQuickNameIconForUid(BatteryStatsImplV18.UidWrapper uidObj) {
